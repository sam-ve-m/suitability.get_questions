...
fission fn create --spec --name suitability-questions-fn --env suitability-questions-env --src "./func/*" --entrypoint main.get_suitability_questions --executortype newdeploy --maxscale 1
