#!/bin/bash
fission spec init
fission env create --spec --name suitability-questions-env --image nexus.sigame.com.br/fission-async:0.1.7 --builder nexus.sigame.com.br/fission-builder-3.8:0.0.1
