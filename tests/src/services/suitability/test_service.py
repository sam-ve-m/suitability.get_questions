...
from tests.src.services.suitability.stubs import stub_suitability_model, stub_response
...
@patch(
    ...
    side_effect=["suitability_key", "suitability_key", "3600*24"],
)
...
@pytest.mark.asyncio
@patch('func.src.services.suitability.service.AsyncCache.get', return_value=stub_response)
